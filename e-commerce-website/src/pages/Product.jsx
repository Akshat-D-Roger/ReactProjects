      ...
      <div className="flex flex-col sm:flex-row gap-[1rem] w-full">
        ...
        <div className="flex-1 sm:pt-[1rem] flex flex-col gap-[1rem] sm:ml-[2rem]">
          ...
          <div className="mt-[1rem]">
            <button className="bg-black text-white border border-gray-200 p-3 px-8" onClick={() => { addToCart(productId, selectedSize, currProduct, setSelectedSize, cartItems, setCartItems) }}>Add to Cart</button>
            <ToastContainer />
          </div>
